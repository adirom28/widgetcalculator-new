...
export const ErrorMessageComponent = (props) => {
    ...
    const {errorMessage, color, bgColor} = props;
    ...
    return (
        <div className="error-container" style={{borderColor: `${color}`, backgroundColor: `${bgColor}`}}>
            <div className={classes.containerIcon}>{warningIcon}</div>
